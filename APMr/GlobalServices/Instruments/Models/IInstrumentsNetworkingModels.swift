...
enum IInstrumentsNetworkingMessageType: Int64 {
    case interfaceDetection = 0
    case connectionDetected = 1
    case connectionUpdate = 2
}

struct IInstrumentsNetworkingInterfaceDetectionModel {
    var interfaceIndex: Int64?
    var name: String?
}

struct IInstrumentsNetworkingConnectionDetectedModelV4 {
...
struct IInstrumentsNetworkingConnectionDetectedModelV6 {
...
struct IInstrumentsNetworkingConnectionUpdateModel {
    var rxPackets: Int64?
    var rxBytes: Int64?
    var txPackets: Int64?
    var txBytes: Int64?
